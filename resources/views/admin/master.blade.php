				 ...
				 <div class="col-md-3 arrival-grid simpleCart_shelfItem">
					 <div class="grid-arr">
						 <div  class="grid-arrival">
							 <figure>
								 <a href="{{route('product_details',['id'=>$product->id])}}" class="new-gri" >
									 <div class="grid-img">
						 ...
						 <div class="women">
							 <h6><a href="single.html">{{($product->product-name)}}</a></h6>
							 <span class="size">XL / XXL / S </span>
							 <p ><del>$100.00</del><em class="item_price">TK.{{($product->product-price)}}</em></p>
