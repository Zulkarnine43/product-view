											...
											<div class="product-tab">
												...
												<div class="col-md-4 product-tab-grid simpleCart_shelfItem">
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{asset($categoryProducts->product-image)}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{asset($categoryProducts->product-image)}}" class="img-responsive"  alt="">
																	</div>			
														...
														<div class="women">
															<h6><a href="single.html">{{$categoryProducts->product-name}}</a></h6>
															<span class="size">XL / XXL / S </span>
															<p ><em class="item_price">TK.{{$categoryProducts->product-price}}</em></p>
                                            ...
                                            <div class="product-tab1">
												...
												<div class="col-md-8 product-tab1-grid1 simpleCart_shelfItem">
													...
													<div class="women">
														<h6><a href="single.html">{{$categoryProducts->product-name}}</a></h6>
														<span class="size">XL / XXL / S </span>
														<p> {{$categoryProducts->short-description}} </p>
														<p ><em class="item_price">Tk.{{$categoryProducts->product-price}}</em></p>
														<a href="#" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
													</div>
												</div>
