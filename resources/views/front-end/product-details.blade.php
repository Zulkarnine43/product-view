                    ...
                    <div class="col-md-9 single-grid">
                        <div clas="single-top">
                                ...
                                <div class="flexslider">
                                    <ul class="slides">
                                        <li data-thumb="{{asset('/')}}/front-end/images/si.jpg">
                                            <div class="thumb-image"> <img src=" {{asset('$product ->product-image')}}" data-imagezoom="true" class="img-responsive"> </div>
                                        </li>
                            ...
                            <div class="single-right simpleCart_shelfItem">
                                ...
                                <p class="price item_price"> <h4>{{$product ->product-price}}</h4></p>
                                <div class="description">
                                    <p><span>Quick Overview : </span> {{$product ->product-name}}.</p>
                                </div>
